...
def initialize_transaction(seter, name, vister):
...
def main_loop():
    ...
    while True:
	    ...
	    #-------------------------------------------------------------------- 
            ...
            cv2.putText(frame,lab, (left + 6, bottom - 6), cv2.FONT_HERSHEY_DUPLEX, 0.8, (255, 255, 255), 1)
